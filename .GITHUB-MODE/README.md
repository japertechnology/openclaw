...
<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/japertechnology/openclaw/main/.GITHUB-MODE.png" alt="OpenClaw with GitHub Mode" width="500">
  </picture>
</p>
...
- GitHub-Mode Docs: https://github.com/japertechnology/openclaw/tree/main/docs/github-mode
- GitHub-Mode Runtime contracts: https://github.com/japertechnology/openclaw/tree/main/runtime/github-mode
...
- **Contract-first design**: machine-readable runtime contracts under `runtime/github-mode/` are validated in CI.
...
- GitHub Mode orchestration lives in `.github/**` and contract/runtime assets under `runtime/github-mode/**`.
...
- ADR 0001 Runtime Boundary and Ownership: https://github.com/openclaw/openclaw/blob/main/docs/github-mode/adr/0001-runtime-boundary-and-ownership.md
- ADR 0002 Installed Runtime Non-Regression Guardrails: https://github.com/openclaw/openclaw/blob/main/docs/github-mode/adr/0002-installed-runtime-non-regression-guardrails.md
...
- `runtime/github-mode/` — runtime contracts and schemas.
- `.github/workflows/github-mode-*` — GitHub Mode CI and policy workflows.
- `scripts/github-mode/` — contract validation and upstream-guard scripts.
- `test/github-mode/` — validation and upstream-sync guard test coverage.
...
- Trigger trust and privilege expectations: https://github.com/openclaw/openclaw/blob/main/docs/github-mode/security/0001-github-trigger-trust-matrix.md
- Skills quarantine pipeline: https://github.com/openclaw/openclaw/blob/main/docs/github-mode/security/0002-skills-quarantine-pipeline.md
...
- Upstream additive-change guard (`scripts/github-mode/check-upstream-additions-only.ts`)
