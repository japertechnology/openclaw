...
> This document is retained for compatibility. The current canonical version is [idea.md](idea.md), which clarifies capability parity targets and intentional interaction non-parity.
...
- `.GITHUB-MODE/runtime/` for mode-specific manifests and policy contracts
