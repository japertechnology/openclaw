...
It builds on `.GITHUB-MODE-MVP.md` by adding one critical bar: the first release must not only be shippable, it must demonstrate a clear long-term product direction.
